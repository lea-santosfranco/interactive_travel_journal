export const REGIONS = {
  lisbonne: {
    ...
    accent: `#b5451b`,
    photo: `https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Pastéis de Belém`, note: `La recette originale, gardée secrète depuis 1837 dans la fabrique de Belém — la crème est plus liquide qu'ailleurs, le feuilleté plus sombre.`, photo: `https://images.unsplash.com/photo-1588591536064-e6c2071bf012?w=400&q=80&fit=crop&auto=format` },
      { nom: `Bacalhau à Brás`, note: `Morue effilée mêlée d'œufs brouillés et de paille de pommes de terre frites, parsemée d'olives noires. Un plat humble devenu emblématique.`, photo: `https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400&q=80&fit=crop&auto=format` },
      { nom: `Ginjinha`, note: `Liqueur de griotte servie dans un minuscule verre de shot, souvent accompagnée d'une cerise au fond. À boire debout, au comptoir, comme un vrai Lisboète.`, photo: `https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=400&q=80&fit=crop&auto=format` },
      { nom: `Amêijoas à Bulhão Pato`, note: `Palourdes ouvertes à la vapeur avec ail, huile d'olive, coriandre et vin blanc. Simple, parfait, maritime.`, photo: `https://images.unsplash.com/photo-1559737558-2f5a35f4523b?w=400&q=80&fit=crop&auto=format` },
      { nom: `Bifanas`, note: `Sandwich au porc mariné dans la sauce piri-piri, servi dans un pain mou. Le fast-food lisboète par excellence, vendu aux coins de rue depuis toujours.`, photo: `https://images.unsplash.com/photo-1550950158-d0d960dff596?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  porto: {
    id: `porto`,
    nom: `Porto`,
    subtitle: `Cidade Invicta`,
    tagline: `Invaincue, rugueuse, généreuse — la ville qui a donné son nom au vin.`,
    accent: `#7b2d8b`,
    photo: `https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Francesinha`, note: `Sandwich XXL de viandes superposées, noyé dans une sauce tomate-bière-épices et couvert d'un œuf sur le plat. Brutal, réconfortant, unique au monde.`, photo: `https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80&fit=crop&auto=format` },
      { nom: `Tripas à moda do Porto`, note: `Tripes aux haricots blancs et saucisse — le plat qui a valu aux habitants de Porto le surnom de tripeiros. Une histoire de sacrifice et de solidarité.`, photo: `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vinho do Porto`, note: `Un apéritif, un digestif, une religion. Le blanc sec est particulièrement sous-estimé — essayez-le frais avec des amandes.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
      { nom: `Bacalhau com natas`, note: `Gratin de morue à la crème, doré au four. Décadent et terriblement bon par temps de pluie.`, photo: `https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=400&q=80&fit=crop&auto=format` },
      { nom: `Pastel de feijão`, note: `Petite tarte aux haricots blancs de Vila do Conde — plus délicate qu'elle n'y paraît, avec un parfum d'amande et de cannelle.`, photo: `https://images.unsplash.com/photo-1588591536064-e6c2071bf012?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  sintra: {
    id: `sintra`,
    nom: `Sintra`,
    subtitle: `Vila Romântica`,
    tagline: `Un décor de conte, des palais dans les nuages, une forêt qui garde ses secrets.`,
    accent: `#2d6e4e`,
    photo: `https://images.unsplash.com/photo-1583422409516-2895a77efded?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Travesseiros`, note: `Feuilletés garnis de crème d'amande et d'œuf, en forme d'oreiller — spécialité de la Piriquita depuis 1862.`, photo: `https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?w=400&q=80&fit=crop&auto=format` },
      { nom: `Queijadas de Sintra`, note: `Petites tartelettes de fromage frais, cannelle et sucre. Légères, anciennes, indissociables de la ville.`, photo: `https://images.unsplash.com/photo-1464305795204-6f5bbfc7fb81?w=400&q=80&fit=crop&auto=format` },
      { nom: `Adega das Caves`, note: `Le restaurant local préféré des habitants — grillades simples, vin de la région, terrasse cachée dans la ruelle.`, photo: `https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vin de Colares`, note: `L'un des rares vignobles au monde plantés dans le sable — les phylloxéras n'y ont jamais survécu. Un vin minéral, rare, presque introuvable ailleurs.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
      { nom: `Mel de Sintra`, note: `Le miel de bruyère et d'eucalyptus des collines environnantes — vendu dans les petites épiceries du centre, à ramener absolument.`, photo: `https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  obidos: {
    id: `obidos`,
    nom: `Óbidos`,
    subtitle: `Vila Medieval`,
    tagline: `Une cité médiévale intacte, offerte à la reine le jour de ses noces.`,
    accent: `#8b6914`,
    photo: `https://images.unsplash.com/photo-1591003680058-9e4d06e45a8f?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Ginjinha d'Óbidos`, note: `Servie dans un verre en chocolat blanc que l'on croque ensuite — l'invention locale la plus délicieuse de tout le Portugal.`, photo: `https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=400&q=80&fit=crop&auto=format` },
      { nom: `Amêijoas na cataplana`, note: `Palourdes cuites dans la cataplana en cuivre, avec tomate, chorizo et poivron. Spécialité remontée du Sud, adoptée avec enthousiasme.`, photo: `https://images.unsplash.com/photo-1559737558-2f5a35f4523b?w=400&q=80&fit=crop&auto=format` },
      { nom: `Caldeirada de peixe`, note: `Ragoût de poissons à l'huile d'olive et au vin blanc — chaque restaurant a sa version, aucune ne ressemble à une autre.`, photo: `https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=400&q=80&fit=crop&auto=format` },
      { nom: `Queijo fresco`, note: `Fromage frais local, servi au petit-déjeuner avec du miel ou de la confiture de figues. Doux, humide, matinal.`, photo: `https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=80&fit=crop&auto=format` },
      { nom: `Licor de Abóbora`, note: `Liqueur de courge dorée, sucrée et épicée — les producteurs locaux en sont très fiers, à raison.`, photo: `https://images.unsplash.com/photo-1558618047-f4e5e42de9c8?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  nazare: {
    id: `nazare`,
    nom: `Nazaré`,
    subtitle: `Terra das Ondas`,
    tagline: `Les vagues les plus hautes du monde, et des femmes en sept jupons.`,
    accent: `#1a5c8a`,
    photo: `https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Peixe seco`, note: `Poisson séché suspendu sur des cordes à linge, séché au vent de l'Atlantique. On l'achète entier dans les ruelles du vieux village — odeur puissante, goût inoubliable.`, photo: `https://images.unsplash.com/photo-1534482421-64566f976cfa?w=400&q=80&fit=crop&auto=format` },
      { nom: `Caldeirada de tamboril`, note: `Ragoût de lotte à l'huile d'olive, pommes de terre et tomate. La lotte absorbe tous les parfums — ici elle est irréprochable.`, photo: `https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=400&q=80&fit=crop&auto=format` },
      { nom: `Percebes`, note: `Pouces-pieds accrochés aux rochers par des pêcheurs intrépides. On les mange bouillis avec du sel de mer, en les ouvrant à la main. Iodé, intense, précieux.`, photo: `https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80&fit=crop&auto=format` },
      { nom: `Filetes de polvo`, note: `Filets de poulpe panés et frits, croustillants dehors, tendres dedans. Servis avec une salade de riz ou des légumes grillés.`, photo: `https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&q=80&fit=crop&auto=format` },
      { nom: `Açorda de marisco`, note: `Soupe de pain à l'ail, aux œufs et aux fruits de mer — épaisse, rustique, nourrissante. La version de la mer de l'açorda alentejana.`, photo: `https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  coimbra: {
    ...
    accent: `#8b1a1a`,
    photo: `https://images.unsplash.com/photo-1569959220744-ff553533f492?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Chanfana`, note: `Cabri mijoté dans du vin rouge pendant des heures, dans une marmite en argile noire. Le plat traditionnel des villages autour de Coimbra — profond et résineux.`, photo: `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format` },
      { nom: `Leitão da Bairrada`, note: `Cochon de lait rôti à la broche, peau croustillante comme du verre, chair fondante. La spécialité de la région de Bairrada, à 30 km à l'ouest.`, photo: `https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80&fit=crop&auto=format` },
      { nom: `Arroz de lampreia`, note: `Riz à la lamproie, préparée de décembre à avril uniquement — le poisson primitif remonté du Mondego est une expérience gustative difficile à qualifier mais impossible à oublier.`, photo: `https://images.unsplash.com/photo-1534482421-64566f976cfa?w=400&q=80&fit=crop&auto=format` },
      { nom: `Pastéis de Santa Clara`, note: `Chaussons à la pâte d'amande et d'œufs — recette des couvents de l'autre rive du Mondego, transmise depuis le XVIIe siècle.`, photo: `https://images.unsplash.com/photo-1588591536064-e6c2071bf012?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vinho da Bairrada`, note: `Un rouge tannique et fruité, produit sur les argiles de la Bairrada voisine. Parfait avec le leitão — une alliance régionale évidente.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  aveiro: {
    id: `aveiro`,
    nom: `Aveiro`,
    subtitle: `Veneza Portuguesa`,
    tagline: `Des canaux, des bateaux peints, et le sel qui fait briller le sol.`,
    accent: `#1a7a6e`,
    photo: `https://images.unsplash.com/photo-1597076545399-91a3ff0e71b3?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Ovos moles`, note: `Pâte d'œuf et sucre enfermée dans des hosties en forme de poisson, coquillage ou barillet — la confiserie emblématique d'Aveiro depuis le XVIe siècle.`, photo: `https://images.unsplash.com/photo-1464305795204-6f5bbfc7fb81?w=400&q=80&fit=crop&auto=format` },
      { nom: `Enguias fritas`, note: `Anguilles de la ria frites dans l'huile d'olive — croustillantes, grasses, avec une salade de tomates simples à côté.`, photo: `https://images.unsplash.com/photo-1519984388953-d2406bc725e1?w=400&q=80&fit=crop&auto=format` },
      { nom: `Salicórnia`, note: `La plante des marais salants servie marinée, en salade ou en tapas dans les restaurants du front de mer. Iodée, croquante, marine.`, photo: `https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&q=80&fit=crop&auto=format` },
      { nom: `Lulas recheadas`, note: `Calamars farcis à la viande hachée et aux herbes, cuits au four dans un fond de tomate. Un plat de dimanche reconverti en restaurant.`, photo: `https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&q=80&fit=crop&auto=format` },
      { nom: `Flor de sal d'Aveiro`, note: `Le sel récolté à la main dans les salines locales — les cristaux fins et légèrement humides se posent sur tout comme une neige précieuse.`, photo: `https://images.unsplash.com/photo-1471506480208-91b3a4cc78be?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  braga: {
    id: `braga`,
    nom: `Braga`,
    subtitle: `Cidade dos Arcebispos`,
    tagline: `La Rome du Portugal, les meilleures fêtes du printemps, et un baroque débridé.`,
    accent: `#5c1a5c`,
    photo: `https://images.unsplash.com/photo-1548707309-dcebeab9ea9b?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Rojões à minhota`, note: `Porc rôti dans sa propre graisse avec cumin et vin vinho verde — le plat traditionnel du Minho, servi avec des couennes croustillantes.`, photo: `https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80&fit=crop&auto=format` },
      { nom: `Papas de sarrabulho`, note: `Bouillie de sang de porc avec diverses viandes — un plat de fête qui remonte au Moyen Âge, servi avec du cumin.`, photo: `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vinho verde`, note: `Le vin légèrement pétillant et frais du Minho — blanc, rosé ou rouge, il accompagne tout et se boit à toute heure.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
      { nom: `Bacalhau à Gomes de Sá`, note: `Morue en lamelles avec pommes de terre, oignons et œufs durs, garnie d'olives. La recette du cuisinier portuense Gomes de Sá, adoptée dans tout le Nord.`, photo: `https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400&q=80&fit=crop&auto=format` },
      { nom: `Pudim Abade de Priscos`, note: `Flan au lard fumé et au porto — une recette de curé du XIXe siècle, sucrée, riche et complètement improbable.`, photo: `https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  guimaraes: {
    ...
    accent: `#4a6741`,
    photo: `https://images.unsplash.com/photo-1549144511-f099e773c147?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Vitela à moda do Minho`, note: `Veau du Minho rôti lentement à l'ail et au romarin — la viande est si tendre qu'elle se défait à la fourchette.`, photo: `https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80&fit=crop&auto=format` },
      { nom: `Sarrabulho de Guimarães`, note: `Version locale du plat sanguin du Minho, servie avec du riz de cumin. Plus épicée qu'à Braga, plus rustique.`, photo: `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format` },
      { nom: `Torta de Guimarães`, note: `Roulé à la crème d'œuf — fin, doré, sucré avec mesure. La pâtisserie emblématique de la ville.`, photo: `https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?w=400&q=80&fit=crop&auto=format` },
      { nom: `Bacalhau à narcisa`, note: `Morue grillée simplement à l'huile d'olive et à l'ail, sans artifice. L'honnêteté du Nord.`, photo: `https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vinho verde Alvarinho`, note: `Le cépage roi du Minho — dans sa version Monção-Melgaço, plus charnu et aromatique que le vinho verde standard. Un grand vin blanc portugais.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  evora: {
    id: `evora`,
    nom: `Évora`,
    subtitle: `Cidade-Museu`,
    tagline: `Un temple romain au milieu des maisons blanches, une chapelle d'ossements, l'Alentejo autour.`,
    accent: `#a0522d`,
    photo: `https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Sopa de cação`, note: `Soupe de requin-hâ à la coriandre et au pain — épaisse, parfumée, maritime malgré la distance à la mer. Le plat alentejano par excellence.`, photo: `https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80&fit=crop&auto=format` },
      { nom: `Migas à alentejana`, note: `Pain rassis émietté dans l'huile d'olive, coriandre et ail, servi avec du porc ou des œufs. Simple, généreux, paysan dans le meilleur sens du terme.`, photo: `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format` },
      { nom: `Queijo de Évora`, note: `Fromage de brebis local, affiné dans la cave — il va du frais et doux au sec et piquant. L'acheter au marché du Giraldo.`, photo: `https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=80&fit=crop&auto=format` },
      { nom: `Vinho alentejano`, note: `Les vins de l'Alentejo — ronds, solaires, riches en alcool — ont révolutionné le paysage viticole portugais dans les années 90. Herdade do Esporão reste la référence.`, photo: `https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=80&fit=crop&auto=format` },
      { nom: `Açorda à alentejana`, note: `Soupe de pain à l'ail et œuf poché — servie dans un bol de terracotta et mangée avec une cuillère en bois. Un plat de pauvres devenu patrimoine.`, photo: `https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  lagos: {
    id: `lagos`,
    nom: `Lagos`,
    subtitle: `Pérola do Algarve`,
    tagline: `Des falaises d'ocre, des criques turquoise, une vieille ville endormie sous les bougainvilliers.`,
    accent: `#c47a1e`,
    photo: `https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Cataplana de frutos do mar`, note: `Fruits de mer cuits dans la cataplana en cuivre hermétique — crevettes, palourdes, moules, avec tomate et coriandre. L'emblème culinaire de l'Algarve.`, photo: `https://images.unsplash.com/photo-1559737558-2f5a35f4523b?w=400&q=80&fit=crop&auto=format` },
      { nom: `Grelhada de peixe`, note: `Poisson entier grillé sur braise — dorade, bar, vieille. Huile d'olive, sel de mer, citron. Rien d'autre. C'est suffisant.`, photo: `https://images.unsplash.com/photo-1519984388953-d2406bc725e1?w=400&q=80&fit=crop&auto=format` },
      { nom: `Caracóis`, note: `Escargots de terre bouillis avec thym, laurier et ail — mangés avec une épingle à la terrasse des tascas. Un rituel estival.`, photo: `https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80&fit=crop&auto=format` },
      { nom: `Dom Rodrigo`, note: `Bonbon à la pâte d'amande et d'œuf enveloppé dans du papier doré — la confiserie algarvienne la plus connue.`, photo: `https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&q=80&fit=crop&auto=format` },
      { nom: `Medronho`, note: `Eau-de-vie de l'arbousier distillée dans les collines de la Serra de Monchique — forte, fruitée, artisanale. À siroter, pas à avaler.`, photo: `https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
  ...
  faro: {
    id: `faro`,
    nom: `Faro`,
    subtitle: `Capital do Algarve`,
    tagline: `La porte d'entrée de l'Algarve garde ses meilleures cartes pour les curieux.`,
    accent: `#2a6a8a`,
    photo: `https://images.unsplash.com/photo-1559827291-72ebaea27082?w=1200&q=80&fit=crop&auto=format`,
    ...
    food: [
      { nom: `Conquilhas`, note: `Petites clovisses de la Ria Formosa, sautées à l'ail et au vin blanc. Minuscules, intenses, iodées. Servies à l'apéritif dans presque tous les bars de la ville.`, photo: `https://images.unsplash.com/photo-1559737558-2f5a35f4523b?w=400&q=80&fit=crop&auto=format` },
      { nom: `Ostras da Ria Formosa`, note: `Les huîtres de la ria sont élevées dans une eau froide et pure — fermes, légèrement sucrées, avec le goût de l'Atlantique direct. À manger sur les pontons.`, photo: `https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80&fit=crop&auto=format` },
      { nom: `Amêijoas à bulhão pato`, note: `Palourdes de la ria à l'huile d'olive, ail et coriandre — la même recette que Lisbonne, mais avec des coquillages qui ont grandi à 50 mètres.`, photo: `https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=400&q=80&fit=crop&auto=format` },
      { nom: `Cataplana de bacalhau`, note: `Morue cuite dans la cataplana avec poivrons, tomate et pois chiches — l'adaptation de l'Algarve à un poisson du nord.`, photo: `https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400&q=80&fit=crop&auto=format` },
      { nom: `Tarte de amêndoa`, note: `Tarte aux amandes algarvienne — fine, caramélisée, légèrement croquante. Vendue dans toutes les pâtisseries de la région.`, photo: `https://images.unsplash.com/photo-1464305795204-6f5bbfc7fb81?w=400&q=80&fit=crop&auto=format` },
    ],
    explore: [
