export const REGIONS = {
  lisbonne: {
    ...
    food: [
      { nom: `Pastéis de Belém`, note: `La recette originale, gardée secrète depuis 1837 dans la fabrique de Belém — la crème est plus liquide qu'ailleurs, le feuilleté plus sombre.` },
      { nom: `Bacalhau à Brás`, note: `Morue effilée mêlée d'œufs brouillés et de paille de pommes de terre frites, parsemée d'olives noires. Un plat humble devenu emblématique.` },
      { nom: `Ginjinha`, note: `Liqueur de griotte servie dans un minuscule verre de shot, souvent accompagnée d'une cerise au fond. À boire debout, au comptoir, comme un vrai Lisboète.` },
      { nom: `Amêijoas à Bulhão Pato`, note: `Palourdes ouvertes à la vapeur avec ail, huile d'olive, coriandre et vin blanc. Simple, parfait, maritime.` },
      { nom: `Bifanas`, note: `Sandwich au porc mariné dans la sauce piri-piri, servi dans un pain mou. Le fast-food lisboète par excellence, vendu aux coins de rue depuis toujours.` },
    ],
    explore: [
  ...
  porto: {
    ...
    food: [
      { nom: `Francesinha`, note: `Sandwich XXL de viandes superposées, noyé dans une sauce tomate-bière-épices et couvert d'un œuf sur le plat. Brutal, réconfortant, unique au monde.` },
      { nom: `Tripas à moda do Porto`, note: `Tripes aux haricots blancs et saucisse — le plat qui a valu aux habitants de Porto le surnom de tripeiros. Une histoire de sacrifice et de solidarité.` },
      { nom: `Vinho do Porto`, note: `Un apéritif, un digestif, une religion. Le blanc sec est particulièrement sous-estimé — essayez-le frais avec des amandes.` },
      { nom: `Bacalhau com natas`, note: `Gratin de morue à la crème, doré au four. Décadent et terriblement bon par temps de pluie.` },
      { nom: `Pastel de feijão`, note: `Petite tarte aux haricots blancs de Vila do Conde — plus délicate qu'elle n'y paraît, avec un parfum d'amande et de cannelle.` },
    ],
    explore: [
  ...
  sintra: {
    ...
    food: [
      { nom: `Travesseiros`, note: `Feuilletés garnis de crème d'amande et d'œuf, en forme d'oreiller — spécialité de la Piriquita depuis 1862.` },
      { nom: `Queijadas de Sintra`, note: `Petites tartelettes de fromage frais, cannelle et sucre. Légères, anciennes, indissociables de la ville.` },
      { nom: `Adega das Caves`, note: `Le restaurant local préféré des habitants — grillades simples, vin de la région, terrasse cachée dans la ruelle.` },
      { nom: `Vin de Colares`, note: `L'un des rares vignobles au monde plantés dans le sable — les phylloxéras n'y ont jamais survécu. Un vin minéral, rare, presque introuvable ailleurs.` },
      { nom: `Mel de Sintra`, note: `Le miel de bruyère et d'eucalyptus des collines environnantes — vendu dans les petites épiceries du centre, à ramener absolument.` },
    ],
    explore: [
  ...
  obidos: {
    ...
    food: [
      { nom: `Ginjinha d'Óbidos`, note: `Servie dans un verre en chocolat blanc que l'on croque ensuite — l'invention locale la plus délicieuse de tout le Portugal.` },
      { nom: `Amêijoas na cataplana`, note: `Palourdes cuites dans la cataplana en cuivre, avec tomate, chorizo et poivron. Spécialité remontée du Sud, adoptée avec enthousiasme.` },
      { nom: `Caldeirada de peixe`, note: `Ragoût de poissons à l'huile d'olive et au vin blanc — chaque restaurant a sa version, aucune ne ressemble à une autre.` },
      { nom: `Queijo fresco`, note: `Fromage frais local, servi au petit-déjeuner avec du miel ou de la confiture de figues. Doux, humide, matinal.` },
      { nom: `Licor de Abóbora`, note: `Liqueur de courge dorée, sucrée et épicée — les producteurs locaux en sont très fiers, à raison.` },
    ],
    explore: [
  ...
  nazare: {
    ...
    food: [
      { nom: `Peixe seco`, note: `Poisson séché suspendu sur des cordes à linge, séché au vent de l'Atlantique. On l'achète entier dans les ruelles du vieux village — odeur puissante, goût inoubliable.` },
      { nom: `Caldeirada de tamboril`, note: `Ragoût de lotte à l'huile d'olive, pommes de terre et tomate. La lotte absorbe tous les parfums — ici elle est irréprochable.` },
      { nom: `Percebes`, note: `Pouces-pieds accrochés aux rochers par des pêcheurs intrépides. On les mange bouillis avec du sel de mer, en les ouvrant à la main. Iodé, intense, précieux.` },
      { nom: `Filetes de polvo`, note: `Filets de poulpe panés et frits, croustillants dehors, tendres dedans. Servis avec une salade de riz ou des légumes grillés.` },
      { nom: `Açorda de marisco`, note: `Soupe de pain à l'ail, aux œufs et aux fruits de mer — épaisse, rustique, nourrissante. La version de la mer de l'açorda alentejana.` },
    ],
    explore: [
  ...
  coimbra: {
    ...
    food: [
      { nom: `Chanfana`, note: `Cabri mijoté dans du vin rouge pendant des heures, dans une marmite en argile noire. Le plat traditionnel des villages autour de Coimbra — profond et résineux.` },
      { nom: `Leitão da Bairrada`, note: `Cochon de lait rôti à la broche, peau croustillante comme du verre, chair fondante. La spécialité de la région de Bairrada, à 30 km à l'ouest.` },
      { nom: `Arroz de lampreia`, note: `Riz à la lamproie, préparée de décembre à avril uniquement — le poisson primitif remonté du Mondego est une expérience gustative difficile à qualifier mais impossible à oublier.` },
      { nom: `Pastéis de Santa Clara`, note: `Chaussons à la pâte d'amande et d'œufs — recette des couvents de l'autre rive du Mondego, transmise depuis le XVIIe siècle.` },
      { nom: `Vinho da Bairrada`, note: `Un rouge tannique et fruité, produit sur les argiles de la Bairrada voisine. Parfait avec le leitão — une alliance régionale évidente.` },
    ],
    explore: [
  ...
  aveiro: {
    ...
    food: [
      { nom: `Ovos moles`, note: `Pâte d'œuf et sucre enfermée dans des hosties en forme de poisson, coquillage ou barillet — la confiserie emblématique d'Aveiro depuis le XVIe siècle.` },
      { nom: `Enguias fritas`, note: `Anguilles de la ria frites dans l'huile d'olive — croustillantes, grasses, avec une salade de tomates simples à côté.` },
      { nom: `Salicórnia`, note: `La plante des marais salants servie marinée, en salade ou en tapas dans les restaurants du front de mer. Iodée, croquante, marine.` },
      { nom: `Lulas recheadas`, note: `Calamars farcis à la viande hachée et aux herbes, cuits au four dans un fond de tomate. Un plat de dimanche reconverti en restaurant.` },
      { nom: `Flor de sal d'Aveiro`, note: `Le sel récolté à la main dans les salines locales — les cristaux fins et légèrement humides se posent sur tout comme une neige précieuse.` },
    ],
    explore: [
  ...
  braga: {
    ...
    food: [
      { nom: `Rojões à minhota`, note: `Porc rôti dans sa propre graisse avec cumin et vin vinho verde — le plat traditionnel du Minho, servi avec des couennes croustillantes.` },
      { nom: `Papas de sarrabulho`, note: `Bouillie de sang de porc avec diverses viandes — un plat de fête qui remonte au Moyen Âge, servi avec du cumin.` },
      { nom: `Vinho verde`, note: `Le vin légèrement pétillant et frais du Minho — blanc, rosé ou rouge, il accompagne tout et se boit à toute heure.` },
      { nom: `Bacalhau à Gomes de Sá`, note: `Morue en lamelles avec pommes de terre, oignons et œufs durs, garnie d'olives. La recette du cuisinier portuense Gomes de Sá, adoptée dans tout le Nord.` },
      { nom: `Pudim Abade de Priscos`, note: `Flan au lard fumé et au porto — une recette de curé du XIXe siècle, sucrée, riche et complètement improbable.` },
    ],
    explore: [
  ...
  guimaraes: {
    ...
    food: [
      { nom: `Vitela à moda do Minho`, note: `Veau du Minho rôti lentement à l'ail et au romarin — la viande est si tendre qu'elle se défait à la fourchette.` },
      { nom: `Sarrabulho de Guimarães`, note: `Version locale du plat sanguin du Minho, servie avec du riz de cumin. Plus épicée qu'à Braga, plus rustique.` },
      { nom: `Torta de Guimarães`, note: `Roulé à la crème d'œuf — fin, doré, sucré avec mesure. La pâtisserie emblématique de la ville.` },
      { nom: `Bacalhau à narcisa`, note: `Morue grillée simplement à l'huile d'olive et à l'ail, sans artifice. L'honnêteté du Nord.` },
      { nom: `Vinho verde Alvarinho`, note: `Le cépage roi du Minho — dans sa version Monção-Melgaço, plus charnu et aromatique que le vinho verde standard. Un grand vin blanc portugais.` },
    ],
    explore: [
  ...
  evora: {
    ...
    food: [
      { nom: `Sopa de cação`, note: `Soupe de requin-hâ à la coriandre et au pain — épaisse, parfumée, maritime malgré la distance à la mer. Le plat alentejano par excellence.` },
      { nom: `Migas à alentejana`, note: `Pain rassis émietté dans l'huile d'olive, coriandre et ail, servi avec du porc ou des œufs. Simple, généreux, paysan dans le meilleur sens du terme.` },
      { nom: `Queijo de Évora`, note: `Fromage de brebis local, affiné dans la cave — il va du frais et doux au sec et piquant. L'acheter au marché du Giraldo.` },
      { nom: `Vinho alentejano`, note: `Les vins de l'Alentejo — ronds, solaires, riches en alcool — ont révolutionné le paysage viticole portugais dans les années 90. Herdade do Esporão reste la référence.` },
      { nom: `Açorda à alentejana`, note: `Soupe de pain à l'ail et œuf poché — servie dans un bol de terracotta et mangée avec une cuillère en bois. Un plat de pauvres devenu patrimoine.` },
    ],
    explore: [
  ...
  lagos: {
    ...
    food: [
      { nom: `Cataplana de frutos do mar`, note: `Fruits de mer cuits dans la cataplana en cuivre hermétique — crevettes, palourdes, moules, avec tomate et coriandre. L'emblème culinaire de l'Algarve.` },
      { nom: `Grelhada de peixe`, note: `Poisson entier grillé sur braise — dorade, bar, vieille. Huile d'olive, sel de mer, citron. Rien d'autre. C'est suffisant.` },
      { nom: `Caracóis`, note: `Escargots de terre bouillis avec thym, laurier et ail — mangés avec une épingle à la terrasse des tascas. Un rituel estival.` },
      { nom: `Dom Rodrigo`, note: `Bonbon à la pâte d'amande et d'œuf enveloppé dans du papier doré — la confiserie algarvienne la plus connue.` },
      { nom: `Medronho`, note: `Eau-de-vie de l'arbousier distillée dans les collines de la Serra de Monchique — forte, fruitée, artisanale. À siroter, pas à avaler.` },
    ],
    explore: [
  ...
  faro: {
    ...
    food: [
      { nom: `Conquilhas`, note: `Petites clovisses de la Ria Formosa, sautées à l'ail et au vin blanc. Minuscules, intenses, iodées. Servies à l'apéritif dans presque tous les bars de la ville.` },
      { nom: `Ostras da Ria Formosa`, note: `Les huîtres de la ria sont élevées dans une eau froide et pure — fermes, légèrement sucrées, avec le goût de l'Atlantique direct. À manger sur les pontons.` },
      { nom: `Amêijoas à bulhão pato`, note: `Palourdes de la ria à l'huile d'olive, ail et coriandre — la même recette que Lisbonne, mais avec des coquillages qui ont grandi à 50 mètres.` },
      { nom: `Cataplana de bacalhau`, note: `Morue cuite dans la cataplana avec poivrons, tomate et pois chiches — l'adaptation de l'Algarve à un poisson du nord.` },
      { nom: `Tarte de amêndoa`, note: `Tarte aux amandes algarvienne — fine, caramélisée, légèrement croquante. Vendue dans toutes les pâtisseries de la région.` },
    ],
    explore: [
